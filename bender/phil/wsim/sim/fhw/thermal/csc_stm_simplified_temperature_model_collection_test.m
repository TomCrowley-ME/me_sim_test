...
%     cnt_cmd_sim_rate = [cnt_cmd_sim_rate; cnt_cmd_sim_rate(end)];
	...
	heater_state_in.signals.values     = uint8(zeros(n,stm_n_temp_sensors));
	heater_state_in.signals.dimensions = [ stm_n_temp_sensors ];
...
sim('csc_stm_simplified_temperature_model_collection_hrn')
