...
**            (see #CFE_TIME_CFG_FAKE_TONE in the platform_inc), then the tone
**            data packet must follow the tone signal.
**
**  \par Limits
...
**      Not Applicable
*/
#define CFE_TBL_MAX_NAME_LENGTH         28
