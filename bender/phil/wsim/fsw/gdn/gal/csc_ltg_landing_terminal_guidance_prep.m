...
ltg_pwpf_trigger_delta_alpha = 0.3;
ltg_pwpf_trigger_delta_alpha = 0.1;
ltg_pwpf_trigger_delta_alpha = 1.0;
ltg_pwpf_trigger_ref_gain = 1.0;
ltg_pwpf_trigger_on_alpha = ltg_pwpf_trigger_ref_gain*(ltg_pwpf_reference_min_delta_v + ltg_pwpf_trigger_delta_alpha);
