...
*/
#define CFE_ES_CDS_CHECK_PATTERN   0x5a5ac3c3
#define CFE_ES_CDS_BLOCK_USED      0xaaaacccc
#define CFE_ES_CDS_BLOCK_UNUSED    0xddddeeee
...
int32 CFE_ES_CreateCDSPool(uint32  CDSPoolSize, uint32  StartOffset)
{
    ...
    uint32  i = 0;
    uint32  Size = (CDSPoolSize & 0xfffffff8);
