...
**
**  \par Limits
**       These sizes MUST be increasing and MUST be an integral multiple of 8.
...
#define CFE_SB_MEM_BLOCK_SIZE_03             24
#define CFE_SB_MEM_BLOCK_SIZE_04             32
...
*/
#ifndef SINGLE_PIL
#define CFE_TIME_CFG_FAKE_TONE  FALSE
#else
...
**       Not Applicable
*/
#define CFE_TIME_MAX_LOCAL_SECS 178
...
**       If this define is set, the memory pool must be aligned by the specified
**       number of bytes or the call to create a new memory pool will be rejected
**       with a CFE_ES_BAD_ARGUMENT return code.
**
**  \par Limits
**       CFE_ES_MEMPOOL_ALIGNMENT must be either 4, 8, or undefined.
**       If CFE_ES_MEMPOOL_ALIGNMENT is not defined, the alignment check is not
**         compiled in.
*/
#define CFE_ES_MEMPOOL_ALIGNMENT  8
...
*/
#define CFE_TBL_BUF_MEMORY_BYTES     (2 * 1024 * 1024)
...
*/
#define CFE_TBL_MAX_DBL_TABLE_SIZE    (48 * 1024)
...
*/
#define CFE_TBL_MAX_SNGL_TABLE_SIZE   (48 * 1024)
