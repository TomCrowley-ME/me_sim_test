...
#define OS_EVENT_INVALID_ARGS          (-33)
#define OS_EVENT_TIMEOUT               (-34)
#define OS_EVENT_NOT_ALL_EVENTS        (-35)
#define OS_EVENT_ALREADY_REGISTERED    (-36)

/*
** Defines for Queue/Event Timeout parameters
*/
#define OS_PEND   (0)
#define OS_CHECK (-1)

/*
** Defines for Event Options parameters
*/
#define OS_EVENT_ALL (0)
#define OS_EVENT_ANY (1)
