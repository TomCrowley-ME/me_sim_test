...
for i_count = 1 : length(mc_i)
    ...
    mc_all_initial(i_count,:) = extract_mcall_initial_from_workspace_nimbus( imc, truth, telem, error );
    mc_all_final(i_count,:)   = extract_mcall_final_from_workspace_nimbus( imc, truth, telem, error ); 
