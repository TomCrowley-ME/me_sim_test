...
% set minimum fluid damping, nominally set to 0.1
...
pendulum_length_min = 1.0;
pendulum_length_max = 1.0;
...
acs_thruster_delay     = (acs_thruster_delay_min + (acs_thruster_delay_max - acs_thruster_delay_min)*rand(mc_n,12))/1000;

% set thruster fire time bias, msec, nominally set to 0
acs_thruster_bias_min = 0.0;
acs_thruster_bias_max = 0.0;
acs_thruster_bias     = (acs_thruster_bias_min + (acs_thruster_bias_max - acs_thruster_bias_min)*rand(mc_n,12))/1000;
