/*
 *   sfun_orb.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        void outputs_orb(uint8 u1[307200], uint8 u2[307200], double u3[2], double y1[16][2], double y2[16][2], void** work1)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 26-Sep-2013 14:52:32
...
/*
   ...
   def.IncPaths = {'/home/khuang/bender/phil/wsim/externals/minopencv', '/home/khuang/bender/phil/wsim/externals/minopencv/include', '/home/khuang/bender/phil/wsim/externals/minopencv/include/opencv2'};
   def.SrcPaths = {'/home/khuang/bender/phil/wsim/externals/minopencv'};
 ...
 */
#define S_FUNCTION_NAME                sfun_orb
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetInputPortWidth(S, 0, 307200);
  ...
  ssSetInputPortWidth(S, 1, 307200);
  ...
  ssSetOutputPortMatrixDimensions(S, 0, 16, 2);
  ...
  ssSetOutputPortMatrixDimensions(S, 1, 16, 2);
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "initialize_orb", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

    /*
     * Register reserved identifier for OutputFcnSpec
     */
    ssRegMdlInfo(S, "outputs_orb", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

    /*
     * Register reserved identifier for TerminateFcnSpec
     */
    ssRegMdlInfo(S, "terminate_orb", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   * Call the legacy code function
   */
  outputs_orb( u1, u2, u3, y1, y2, &work1);
