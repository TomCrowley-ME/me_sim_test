...
% THRUST PARAMETERS
    ...
    % acs thruster data DIY Configuration 5 lbf Coarse
    psp_coarse_acs_thrust = 25.5773;
    psp_coarse_acs_isp    = 44;
...
% coarse ACS
    ...
    % Thruster 1 Geometry
    psp_thruster1_position    =  [0.6668,-0.0699,-0.22];
    psp_thruster1_orientation =  [0,0.259,0.966];

    % Thruster 2 Geometry
    psp_thruster2_position    =  [0.6668,0,-0.22];
    psp_thruster2_orientation =  [0,0,1];

    % Thruster 3 Geometry
    psp_thruster3_position    =  [0.6668,0.0699,-0.22];
    psp_thruster3_orientation =  [0,-0.259,0.966];

    % Thruster 4 Geometry
    psp_thruster4_position    =  [0.0699,0.6668,-0.22];
    psp_thruster4_orientation =  [-0.259,0,0.966];

    % Thruster 5 Geometry
    psp_thruster5_position    =  [0,0.6668,-0.22];
    psp_thruster5_orientation =  [0,0,1];

    % Thruster 6 Geometry
    psp_thruster6_position    =  [-0.0699,0.6668,-0.22];
    psp_thruster6_orientation =  [0.259,0,0.966];

    % Thruster 7 Geometry
    psp_thruster7_position    =  [-0.6668,0.0699,-0.22];
    psp_thruster7_orientation =  [0,-0.259,0.966];

    % Thruster 8 Geometry
    psp_thruster8_position    =  [-0.6668,0,-0.22];
    psp_thruster8_orientation =  [0,0,1];

    % Thruster 9 Geometry
    psp_thruster9_position    =  [-0.6668,-0.0699,-0.22];
    psp_thruster9_orientation =  [0,0.259,0.966];

    % Thruster 10 Geometry
    psp_thruster10_position    =  [-0.0699,-0.6668,-0.22];
    psp_thruster10_orientation =  [0.259,0,0.966];

    % Thruster 11 Geometry
    psp_thruster11_position    =  [0,-0.6668,-0.22];
    psp_thruster11_orientation =  [0,0,1];

    % Thruster 12 Geometry
    psp_thruster12_position    =  [0.0699,-0.6668,-0.22];
