...
% Uniform distribution with position error 50 meters and 1.5 m/s                     
mc_6dof_variables=cat(2, percent_errors,...
                         max_ranges, ...
                        1.00*(-28.8675 + rand(mc_n,1)*57.73502), ...
                        1.00*(-28.8675 + rand(mc_n,1)*57.73502), ...
                        1.00*(-28.8675 + rand(mc_n,1)*57.73502), ...
                        1.00*(-0.8660 + rand(mc_n,1)*1.7320), ...
                        1.00*(-0.8660 + rand(mc_n,1)*1.7320), ...
                        1.00*(-0.8660 + rand(mc_n,1)*1.7320), ...
                        st_noise_vec, ...
                        integ_time_vec, ...
                        ...
                        delta_t_vec, ...
                        delay_t_vec, ...
                        1.00*sqrt(0.5*(0.01/3)^2)*rand(mc_n,1), ...
                        1.00*sqrt(0.5*(0.01/3)^2)*rand(mc_n,1), ...
                        1.00*(0.01/3)*rand(mc_n,1), ...
                        1.00*sqrt(0.5*(0.01/3)^2)*rand(mc_n,1), ...
                        1.00*sqrt(0.5*(0.01/3)^2)*rand(mc_n,1), ...
                        1.00*(0.01/3)*rand(mc_n,1)...
                        );
...
csc_gdn_option_select = 4; % Mighty Eagle Test Configuration
