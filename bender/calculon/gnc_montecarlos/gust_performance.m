...
mc_prefix_s = 'mtv_gusts_mc';
mc_prefix_s_pos = 'mtv_gusts_pos_mc';
mc_prefix_workspace = 'mtv_gusts_workspace_mc';
...
gust_magnitude_min = 1.0;
gust_magnitude_max = 10.0;
...
ivars = struct( 'ldr_2k_percent_error',1,...
                ...
                'gust_magnitude',73,'gust_start',74,...
                'gust_length',75,'gust_direction',76,...
                'n',76);
