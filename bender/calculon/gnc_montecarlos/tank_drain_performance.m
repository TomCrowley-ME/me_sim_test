...
mc_prefix_s = 'mtv_tank_drain_mc';
mc_prefix_s_pos = 'mtv_tank_drain_pos_mc';
mc_prefix_workspace = 'mtv_tank_drain_workspace_mc';
...
drain_efficiency_min = 0.8;
drain_efficiency_max = 1.2;
