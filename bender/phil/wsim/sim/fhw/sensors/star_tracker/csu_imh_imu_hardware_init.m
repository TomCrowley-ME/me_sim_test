...
imh_accel_sensitivity=.00098;  %100 uG  converted to m/s^2
imh_gyro_sensitivity = .1/3600*pi/180;  %.1 deg per hour converted to rad/s
imh_accel_range = 40*9.8;   % 40 g's in m/s^2
imh_gyro_range = 1000*pi/180;  %1000 deg/s in rad/s
...
imh_gyro_noise_spec = 0.07; %deg/sqrt(hr)
imh_gyro_bias_spec = 1; %deg/hr
imh_gyro_SF = 100/1e6;
...
imh_accel_noise_spec = 50e-6;  % 50 microG/sqrt(hz)
imh_accel_bias_spec = 50e-6;  % 50 microG
imh_accel_SF = 300/1e6;
