...
for iter=1:size(mc_all_final,1)
   ...
   lateral_cg_wet_offset(iter)   = norm(mc_all_initial(iter,26:27));
...
title('Touchdown Lateral Velocity vs Vertical Velocity',14)
...
ylabel('Success=1 Fail=0')
axis([-1 +1 -1 +2]);axis('auto x')
set(gcf,'Name','Landing Success vs Dry Lander CG Offset')
...
if exist('lateral_cg_dry_offset_success')==1
    ...
    ylabel('Number of Cases','fontsize',14)
    set(gcf,'Name','Histogram: Dry Lander CG Offset to Landing Success')
...
if exist('lateral_cg_dry_offset_fail')==1
    ...
    xlabel('Dry Lander CG Offset (mm)','fontsize',14)
    ylabel('Number of Cases','fontsize',14)
    set(gcf,'Name','Histogram: Dry Lander CG Offset to Landing Failure')
...
xlabel('Lateral Offset (millimeters)')
ylabel('Success=1 Fail=0')
set(gcf,'Name','Landing Success vs Wet Lander CG Offset')
axis([-1 +1 -1 +2]);axis('auto x')
...
if exist('lateral_cg_wet_offset_success')==1
    ...
    ylabel('Number of Cases','fontsize',14)
    set(gcf,'Name','Histogram: Wet Lander CG Offset to Landing Success')
...
if exist('lateral_cg_wet_offset_fail')==1
    ...
    xlabel('Wet Lander CG Offset (mm)','fontsize',14)
    ylabel('Number of Cases','fontsize',14)
    set(gcf,'Name','Histogram: Wet Lander CG Offset to Landing Failure')
