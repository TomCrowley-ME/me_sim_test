...
/* Platform is now defined as a compile option -- put platform-specific defs in here */
/* Currently we are running with strictly Linux fortran options -- this may change */
