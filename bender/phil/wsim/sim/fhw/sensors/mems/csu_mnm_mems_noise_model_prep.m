...
%-------------------------------------------------------------------------%
% csc_mum_mems_unit_model_prep.m                                          %
%                                                                         %
% 08/18/14                                                                %
%-------------------------------------------------------------------------%
...
mnm_accel_noise_v = mnm_acel_noise_sigma*[1 1 1]; 
mnm_gyro_noise_v = mnm_gyro_noise_sigma*[1 1 1];  

mnm_accel_bias_noise_v = mnm_accel_bias_noise_source*[1 1 1]; 
mnm_gyro_bias_noise_v  = mnm_gyro_bias_noise_source*[1 1 1];

mnm_accel_sensitivity = mnm_accel_range/32767;
mnm_gyro_sensitivity  = mnm_gyro_range /32767;