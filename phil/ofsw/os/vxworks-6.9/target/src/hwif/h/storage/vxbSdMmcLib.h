...
#define EXT_CSD_SET_BITS    0x1
#define EXT_CSD_CLEAR_BITS  0x2
...
#define MMC_EXT_CSD_ARG_FORM(access, index, value, set)  \
    (((access) << 24) | \
     ((index) << 16) | \
     ((value) << 8) | \
     ((set)))
...
#define SD_VERSION_MMC3             3
#define SD_VERSION_MMC4             4
#define SD_VERSION_MAX              5
