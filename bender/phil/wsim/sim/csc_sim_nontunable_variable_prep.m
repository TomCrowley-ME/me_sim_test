...
%-------------------------------------------------------------------------%
% csc_sim_nontunable_variable_prep.m                                      %
%                                                                         %
% 07/24/14                                                                %
%-------------------------------------------------------------------------%
...
% EPH :  these params are not suited for tuning at this time
    ...
    % Convert utc to et: (CURRENTLY HAVE TO MANUALLY CHANGE THIS IN SIM.PROC FILE)
    ...
    for i = 1 : nelements
        ...
        % Create Moon-to-Earth, Moon-to-Sun vectors in J2000 frame.
        % ('MOON_PA' is more accurate representation of MCMF_PA frame than'IAU_MOON')
