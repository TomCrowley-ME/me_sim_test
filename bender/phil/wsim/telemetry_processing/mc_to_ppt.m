...
page(1).pics=strvcat('TrueXPos.png',...
                     'TrueYPos.png',...
                     'TrueZPos.png',...
                     'TruePosLateral.png');
page(2).pics=strvcat('TrueXVel.png',...
                     'TrueYVel.png',...
                     'TrueZVel.png',...
                     'LateralPosErr.png');
page(3).pics=strvcat('VelocityvsAltitude.png',...
                     'VelocityvsTime.png',...
                     'HtpUsed.png',...
                     'Gn2Used.png');
page(4).pics=strvcat('CgXPos.png',...
                     'CgYPos.png',...
                     'CgZPos.png');
page(5).pics=strvcat('LateralCMandPosErr.png',...
                     'LateralCMandMaxLatExcursion.png',...
                     'LateralCMAzimuthandPosErr.png',...
                     'LateralCMAzimuthandMaxLatExcursion.png');
page(6).pics=strvcat('LateralCMandPropUsed.png',...
                     'EgcMisalignandPosErr.png',...
                     'LateralCMAzimuthandPropUsed.png',...
                     'EgcMisalignAzandPosErr.png');
page(7).pics=strvcat('EgcThottle.png',...
                     'EgcDesiredThrust.png',...
                     'EgcWeightOffset.png',...
                     'CmdZVelErr.png');
page(8).pics=strvcat('LateralVerticalVel.png',...
                     'LateralPosErrandPosEstErr.png',...
                     'TDAngleVsRate.png');
