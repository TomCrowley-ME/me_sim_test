...
*
* NOTE: This routine uses flash memory, since there is no NVRAM on the CAB.
*
...
STATUS sysNvRamGet
    ...
    retVal = sysFlashGet (string, strLen, offset + NVRAM_START_ADDR);
    string [strLen] = EOS;
...
STATUS sysNvRamSet
    ...
    return (sysFlashSet (string, strLen, offset + NVRAM_START_ADDR));
    }
