...
%%
load(cat(2,'scn83_wsim_data',sep,'sim_tlm_msg.mat'))
x=size(data.pos_topo.Time,1);
n=3000+min(find(data.pos_topo.Data(3000:end,3)==data.pos_topo.Data(3000-1:end-1,3)));
...
%%
load(cat(2,'scn83_wsim_data',sep,'sim_data_bus_msg.mat'))
figure
