...
*/
#define CFE_ES_CHECK_PATTERN           0x5a5ac3c3
#define CFE_ES_MEMORY_ALLOCATED        0xaaaacccc
#define CFE_ES_MEMORY_DEALLOCATED      0xddddeeee
/*****************************************************************************/
/*
** Type Definitions
*/
...
#if CFE_ES_MEMPOOL_ALIGNMENT == 8
   /* Determine if the memory pool address is 64-bit aligned */
   if ((((uint32)MemPtr) & 0x00000007) != 0)
   {
      CFE_ES_WriteToSysLog("CFE_ES:poolCreate Pool Address(0x%08X) is not 64-bit aligned.\n", (uint32)MemPtr);
      return(CFE_ES_BAD_ARGUMENT);
   }
#elif CFE_ES_MEMPOOL_ALIGNMENT == 4
